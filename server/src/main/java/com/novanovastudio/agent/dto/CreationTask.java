 ...
 * @param taskRole String 工作流内的业务角色
...
public record CreationTask(
     ...
     * @param toolArguments Map<String, Object> 画布工具参数
     */
    public CreationTask(String taskId, String taskType, String action, String prompt, String sourcePromptId,
                        List<String> dependsOn, String toolName, Map<String, Object> toolArguments) {
        this(taskId, taskType, action, prompt, sourcePromptId, dependsOn, toolName, toolArguments, null);
    }
    ...
    public CreationTask(String taskId, String taskType, String action, String prompt,
                        List<String> dependsOn, String toolName, Map<String, Object> toolArguments) {
        this(taskId, taskType, action, prompt, null, dependsOn, toolName, toolArguments, null);
    }
}
