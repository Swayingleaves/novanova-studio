...
| Credits were deducted but the task failed | Check the credit history for the entry, then give the administrator the approximate time so they can look at credit usage and the API logs |
