...
export const homepageFallbackShowcases: HomepageShowcase[] = [
    ...
    ...[
        ...
        ["缓冲地带", "海岸工业区的抽象运动短片。", "概念短片", "张简", "image", "video", "海岸工业区抽象运动短片，缓慢推镜，低饱和颗粒电影质感"],
        ["平行苏打", "气泡饮料的超现实广告创意。", "商业广告", "Miro", "image", "image", "超现实气泡饮料广告，透明液体悬浮，明快图形化光线，无文字"],
        ["青铜守望", "古代遗迹与科幻机甲的游戏场景。", "游戏美术", "南屿", "image", "image", "古代青铜遗迹与科幻机甲的游戏场景，宏大构图，黄昏体积光"],
        ["失重丝绸", "漂浮布料的时装造型影像。", "时尚影像", "Iris Zou", "image", "image", "漂浮丝绸时装造型影像，纯净黑色空间，柔软轮廓光，优雅动势"],
        ["玻璃脉冲", "透明音响设备的材质研究。", "产品视觉", "Unit 11", "image", "image", "透明音响设备产品视觉，玻璃与金属结构，暗场边缘光，工业精密感"],
        ["森林信号", "户外装备与山地徒步的生活方式作品。", "生活方式", "周野", "image", "image", "山地徒步生活方式创作，清晨森林，技术户外装备，真实自然光"],
        ["潮汐档案", "海岸记忆的编辑式拼贴创作。", "视觉海报", "Owl Press", "image", "image", "海岸记忆编辑式视觉拼贴，无文字，蓝黑潮汐纹理与档案摄影感"],
