...
type CanvasNodeContextMenuProps = { menu: ContextMenuState; onClose: () => void; onCreateNode: (kind: CanvasNodeKind) => void; onDuplicate: () => void; onDelete: () => void; onDeleteBackgroundOnly: () => void };
type MenuAction = { key: string; label: string; icon: ComponentType<{ className?: string }>; danger?: boolean; run: () => void };

export function CanvasNodeContextMenu({ menu, onClose, onCreateNode, onDuplicate, onDelete, onDeleteBackgroundOnly }: CanvasNodeContextMenuProps) {
