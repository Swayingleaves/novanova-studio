...
> 视频生成 V2 接口，通过多模态 content 数组输入（文本 / 图片 / 视频 / 音频），支持文生视频、图生视频（首尾帧）、多模态参考生视频，2K 直出。<br /><br />提示：若需要使用 MiniMax H3，请点击 [按量购买 API](/docs/guides/pricing-paygo#%E8%A7%86%E9%A2%91)。
